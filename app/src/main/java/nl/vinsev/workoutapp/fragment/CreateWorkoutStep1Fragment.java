...
import nl.vinsev.workoutapp.databinding.FragmentCreateWorkoutStep1Binding;
import nl.vinsev.workoutapp.model.Exercise;
import nl.vinsev.workoutapp.model.Workout;

public class CreateWorkoutStep1Fragment extends Fragment {

    private FragmentCreateWorkoutStep1Binding fragmentCreateWorkoutStep1Binding;
    private Button nextStep;
    private ScrollView scrollView;
    private LinearLayout linearLayout;
    private CreateWorkoutActivity createWorkoutActivity;

    public synchronized static CreateWorkoutStep1Fragment newInstance() {
        return new CreateWorkoutStep1Fragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        fragmentCreateWorkoutStep1Binding = FragmentCreateWorkoutStep1Binding.inflate(getLayoutInflater());
        scrollView = fragmentCreateWorkoutStep1Binding.scrollAddExercises;
        linearLayout = fragmentCreateWorkoutStep1Binding.lExercises;

        return fragmentCreateWorkoutStep1Binding.getRoot();
    }
    ...
    public void onResume() {
        super.onResume();
        getActivity().setTitle(R.string.title_fragment_create_workout_step1);
    }
    ...
    private void setupNextStepButton() {
        ...
        nextStep.setOnClickListener(onClick -> {
            createWorkoutActivity.replaceFragment(CreateWorkoutStep2Fragment.newInstance());
    ...
    private void getExercisesForScrollView() {
        ArrayList<Exercise> exercises = ExerciseController.getInstance().getExercises();
